        ...
        Package for Linux kernels 2.4, 2.6, 3.19, 4.4
 ...
 - CAEN A2818 PCI CARD
 - Linux kernel Rel. 2.4/2.6/3.x/4.4 with gnu C/C++ compiler
 ...
 ------------------
  ...
  - Excecute: cp ./Makefile.2.4 Makefile (for 2.4 kernel) cp ./Makefile.2.6-3.x Makefile (for 2.6/4.4 kernel)

  - Execute: make

  - Execute: sh a2818_load.2.4 (for 2.4 kernel) 
             or sh a2818_load (for 2.6/4.4 kernel)
