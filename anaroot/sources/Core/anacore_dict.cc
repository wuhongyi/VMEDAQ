...
"/opt/root60606/include",
"/home/wuhongyi/VMEDAQ/anaroot/sources/Core/",
0
    };
...
class __attribute__((annotate("$clingAutoload$include/TArtDecoderA3100.hh")))  TArtDecoder;
...
class __attribute__((annotate("$clingAutoload$include/TArtEventStore.hh")))  TArtStoreManager;
class __attribute__((annotate("$clingAutoload$include/TArtParserFactory.hh")))  TArtParserFactory;
class __attribute__((annotate("$clingAutoload$include/TArtEventStore.hh")))  TArtParser;
...
class __attribute__((annotate("$clingAutoload$include/TArtDecoderA3100.hh")))  TArtRawFADCDataObject;
class __attribute__((annotate("$clingAutoload$include/TArtDecoderA3100.hh")))  TArtRawDataObject;
class __attribute__((annotate("$clingAutoload$include/TArtDecoderA3100.hh")))  TArtRawSegmentObject;
class __attribute__((annotate("$clingAutoload$include/TArtEventStore.hh")))  TArtRawScalerObject;
class __attribute__((annotate("$clingAutoload$include/TArtEventStore.hh")))  TArtRawEventObject;
class __attribute__((annotate("$clingAutoload$include/TArtEventInfo.hh")))  TArtEventInfo;
class __attribute__((annotate("$clingAutoload$include/TArtSharedMemoryDataSource.hh")))  TArtSharedMemory;
