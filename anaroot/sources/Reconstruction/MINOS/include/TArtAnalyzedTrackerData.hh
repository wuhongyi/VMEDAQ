#ifndef TARTANALYZEDTrackerDATA_H
#define TARTANALYZEDTrackerDATA_H
#include <Riostream.h>

#include "TObject.h"

class TArtAnalyzedTrackerData : public TObject {

 public:
  TArtAnalyzedTrackerData(){}

  virtual ~TArtAnalyzedTrackerData(){}
...
//virtual void SetChi2(Double_t val){Chi2 = val;}
 ...
 private:
  ...
  ClassDef(TArtAnalyzedTrackerData,1);
};
#endif // end of #ifndef TTrackerANALYZEDDATA_H
